...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.breez.breez_sdk_liquid.BreezSDKLiquidPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_breez_liquid, com.breez.breez_sdk_liquid.BreezSDKLiquidPlugin", e);
    }
    try {
