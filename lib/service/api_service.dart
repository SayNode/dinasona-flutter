...
class APIService extends GetxService {
  ...
  Future<http.Response> patch(
    ...
    final Uri url =
        Uri.https(DinasonaConstants.apiDomain, path, queryParameters);
    debugPrint(
  ...
  /// Put request to Dinasona backend.
  /// [path] the path to the endpoint.
  /// [body] is the body of the request.
  ...
  /// Post request to Dinasona backend.
  /// [path] the path to the endpoint.
  /// [body] is the body of the request.
  ...
  /// Get request to Dinasona backend.
  /// [path] the path to the endpoint.
  ...
  /// Delete request to Dinasona backend.
  /// [path] the path to the endpoint.
  /// [body] is the body of the request.
